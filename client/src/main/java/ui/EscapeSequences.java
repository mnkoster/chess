 ...
 * 3/17/26: imported for p5 pre-gameplay from starter-code
 */
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_GREY = SET_BG_COLOR + "238m";
    ...
    public static final String SET_BG_COLOR_LIGHTER_GREEN = SET_BG_COLOR + "46m";
    public static final String SET_BG_COLOR_MAGENTA = SET_BG_COLOR + "5m";
    public static final String SET_BG_COLOR_WHITE = SET_BG_COLOR + "15m";
    public static final String SET_BG_COLOR_DARKER_GREEN = SET_BG_COLOR + "22m";
    public static final String SET_BG_COLOR_LIGHT_GREEN = SET_BG_COLOR + "40m";
    public static final String SET_BG_COLOR_DARK_BLUE = SET_BG_COLOR + "19m";
